...
- **Test execution**: run creation from a test-case picker with optional folder assignment, keyboard-driven execution UI (P/F/B/S shortcuts, arrow-key navigation), notes per result
